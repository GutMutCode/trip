...
- `logistics/` - 짐, 출발 전 준비, 현지 실행 보조 체크리스트
...
- [도쿄 3박 4일 짐 체크리스트](logistics/tokyo-3n4d-packing-list.md) - 일정별 활동과 항공/전원 주의사항을 반영한 패킹 목록
...
- 짐, 출발 전 준비, 현지 실행 보조 체크리스트는 `logistics/`에 둡니다.
